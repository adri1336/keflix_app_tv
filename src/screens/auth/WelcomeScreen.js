        ...
        <View style={{
            ...
            <View style={{ flex: 80 }}>
                ...
                <View style={{
                    ...
                    <BoxButton textStyle={[ Styles.bigText, { paddingLeft: Definitions.DEFAULT_MARGIN * 2, paddingRight: Definitions.DEFAULT_MARGIN * 2 } ]}>{ i18n.t("auth.welcome.login_button") }</BoxButton>
                </View>
            </View>
